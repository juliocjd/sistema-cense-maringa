...
const horaString = z.string().regex(horaRegex, "Horario deve estar no formato HH:MM");
...
const configuracaoSchema = z.object({
  ...
  janelaIdentificacaoManhaInicio: horaString,
  janelaIdentificacaoManhaFim: horaString,
  janelaIdentificacaoTardeInicio: horaString,
  janelaIdentificacaoTardeFim: horaString,
  horarioManhaInicio: horaString,
  horarioManhaFim: horaString,
  horarioTardeInicio: horaString,
  horarioTardeFim: horaString,
  ...
  try {
    ...
    if (!config) {
      ...
      return NextResponse.json({
        ...
        janelaIdentificacaoManhaInicio: "08:00",
        janelaIdentificacaoManhaFim: "09:00",
        janelaIdentificacaoTardeInicio: "13:00",
        janelaIdentificacaoTardeFim: "14:00",
        horarioManhaInicio: "08:00",
        horarioManhaFim: "12:00",
        horarioTardeInicio: "13:00",
        horarioTardeFim: "17:00",
    ...
    return NextResponse.json({
      ...
      janelaIdentificacaoManhaInicio: config.janelaIdentificacaoManhaInicio,
      janelaIdentificacaoManhaFim: config.janelaIdentificacaoManhaFim,
      janelaIdentificacaoTardeInicio: config.janelaIdentificacaoTardeInicio,
      janelaIdentificacaoTardeFim: config.janelaIdentificacaoTardeFim,
      horarioManhaInicio: config.horarioManhaInicio,
      horarioManhaFim: config.horarioManhaFim,
      horarioTardeInicio: config.horarioTardeInicio,
      horarioTardeFim: config.horarioTardeFim,
    ...
    return NextResponse.json(
      {
        ...
        janelaIdentificacaoManhaInicio: novaConfig.janelaIdentificacaoManhaInicio,
        janelaIdentificacaoManhaFim: novaConfig.janelaIdentificacaoManhaFim,
        janelaIdentificacaoTardeInicio: novaConfig.janelaIdentificacaoTardeInicio,
        janelaIdentificacaoTardeFim: novaConfig.janelaIdentificacaoTardeFim,
        horarioManhaInicio: novaConfig.horarioManhaInicio,
        horarioManhaFim: novaConfig.horarioManhaFim,
        horarioTardeInicio: novaConfig.horarioTardeInicio,
        horarioTardeFim: novaConfig.horarioTardeFim,
